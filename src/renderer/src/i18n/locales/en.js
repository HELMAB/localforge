export default {
  ...
  nginxBasicSettings: 'Basic Settings',
  nginxPaths: 'Paths',
  nginxOptions: 'Options',
  nginxProjectSelect: 'Select Project',
  nginxProjectSelectPlaceholder: 'Choose an existing project...',
  nginxNoProjectsFound: 'No projects found. Create a project first.',
  nginxCustomPath: 'Use custom path',
  portConflictWarning: 'Port {port} may already be in use',
  enablePHPFPM: 'Enable PHP-FPM',
  enablePHPFPMDesc: 'Use PHP-FPM for processing PHP files (required for Laravel and WordPress)',
  ...
  composerDescription: 'Dependency manager for PHP programming language',
  ...
  nginxDescription: 'A high-performance HTTP server and reverse proxy',
  ...
  postgresqlDescription: 'Powerful, open source object-relational database system',
  ...
  mysqlDescription: "The world's most popular open-source database",
