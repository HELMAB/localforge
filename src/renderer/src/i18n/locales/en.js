export default {
  ...
  noNodeVersionsInstalled: 'No Node.js versions found. Install Node.js via NVM in the Manage Tools tab.',
  noPhpVersionsInstalled: 'No PHP versions found. Install PHP in the Manage Tools tab.',
