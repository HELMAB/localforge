<template>
  <div class="lg-panel overflow-hidden">
    <!-- New Site Form -->
    <div v-if="activeMenu === 'new-site'" class="p-4 sm:p-6 overflow-y-auto h-full">
      <div class="space-y-6">
        <div class="mb-6">
          <div class="flex items-center justify-between">
            ...
            <button
              v-if="editMode"
              class="px-4 py-2 text-muted-foreground hover:bg-background/50 rounded-xl transition-colors"
              @click="cancelEdit"
            >
        ...
        <button
          ...
          class="w-full px-6 py-3 bg-primary text-primary-foreground rounded-xl hover:bg-primary/90 font-semibold disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
    ...
    <!-- Sites List -->
    <div v-else-if="activeMenu === 'sites'" class="p-4 sm:p-6 overflow-y-auto h-full">
      <div class="space-y-6">
        <!-- Header -->
        <div class="mb-6">
          <div class="flex items-center justify-between mb-4">
            ...
            <button
              :disabled="isLoading"
              class="px-4 py-2 bg-primary text-primary-foreground rounded-xl hover:bg-primary/90 disabled:opacity-50 transition-colors flex items-center gap-2 font-semibold"
              @click="loadConfigs"
            >
          ...
          <div class="space-y-3">
            ...
            <div class="relative">
              ...
              <input
                v-model="searchQuery"
                type="text"
                class="w-full pl-10 pr-4 py-2.5 border border-border rounded-xl bg-background/40 text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring transition-colors"
            ...
            <div class="flex flex-wrap gap-2">
              <!-- Status Filters -->
              <div
                class="flex gap-1 bg-background/35 border border-border/60 p-1 rounded-xl backdrop-blur-xl"
              >
                <button
                  :class="[
                ...
                <button
                  :class="[
                    'px-3 py-1.5 text-sm font-semibold rounded-lg transition-colors',
                    statusFilter === 'active'
                      ? 'bg-background/60 text-green-700 dark:text-green-400 shadow-sm'
                      : 'text-muted-foreground hover:text-foreground',
                  ]"
                ...
                <button
                  :class="[
                    ...
                    statusFilter === 'inactive'
                      ? 'bg-background/60 text-foreground/80 shadow-sm'
                      : 'text-muted-foreground hover:text-foreground',
                  ]"
              ...
              >
                ...
                <button
                  :class="[
                    'px-3 py-1.5 text-sm font-semibold rounded-lg transition-colors flex items-center gap-1',
                    sslFilter === 'https'
                      ? 'bg-background/60 text-primary shadow-sm'
                      : 'text-muted-foreground hover:text-foreground',
                  ]"
                ...
                <button
                  :class="[
                    'px-3 py-1.5 text-sm font-semibold rounded-lg transition-colors',
                    sslFilter === 'no-https'
                      ? 'bg-background/60 text-yellow-700 dark:text-yellow-400 shadow-sm'
                      : 'text-muted-foreground hover:text-foreground',
                  ]"
              ...
              <div
                ...
                class="flex items-center px-3 py-1.5 text-sm text-muted-foreground bg-background/35 border border-border/60 rounded-xl backdrop-blur-xl"
              >
            ...
            <div class="space-y-2">
              ...
              >
                ...
                <div class="flex items-center justify-between p-4">
                  <button class="flex-1 min-w-0 text-left" @click="toggleSiteDetails(config.name)">
                        ...
                        <Star
                          ...
                          :class="
                            isFavorite('nginxConfigs', config.name)
                              ...
                              : 'text-gray-400'
                          "
                          :fill="isFavorite('nginxConfigs', config.name) ? 'currentColor' : 'none'"
                        />
                      </button>
                      <ChevronRight
                        :class="[
