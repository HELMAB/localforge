...
export const projectNameSchema = yup.object({
  projectName: yup
    ...
    .matches(/^[a-z0-9-]+$/, 'Project name can only contain lowercase letters, numbers, and hyphens')
...
export const phpExtensionSchema = yup.object({
  extensions: yup
    ...
    .matches(/^[a-z0-9-]+(,[a-z0-9-]+)*$/, 'Extensions must be comma-separated (e.g., curl,mbstring,xml)')
})
