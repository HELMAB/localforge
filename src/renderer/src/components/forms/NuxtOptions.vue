<template>
  <div class="space-y-4">
    ...
    <div>
      <label class="block text-sm font-medium mb-2 dark:text-gray-300">{{ t('nuxtVersionLabel') }}</label>
      <CustomSelect
    ...
    <div v-if="nuxtVersion === '4'">
      <label class="block text-sm font-medium mb-2 dark:text-gray-300">{{ t('nuxtTemplateLabel') }}</label>
      <CustomSelect
